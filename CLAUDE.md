...
**Phase 2** — Real-time webcam demo on Mac M5 via ONNX Runtime + CoreML EP. **Released 2026-09-19** — see `scripts/webcam_demo.py` and the Mac M5 status table below.
